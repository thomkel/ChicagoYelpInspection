...
class InspectionsControllerTest < ActionController::TestCase
  ...
  test "should create inspection" do
    assert_difference('Inspection.count') do
      post :create, inspection: { inspect_date: @inspection.inspect_date, inspect_id: @inspection.inspect_id, results: @inspection.results, violations: @inspection.violations }
    end
  ...
  test "should update inspection" do
    patch :update, id: @inspection, inspection: { inspect_date: @inspection.inspect_date, inspect_id: @inspection.inspect_id, results: @inspection.results, violations: @inspection.violations }
    assert_redirected_to inspection_path(assigns(:inspection))
  end
